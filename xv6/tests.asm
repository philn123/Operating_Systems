...
int main(int argc, char *argv[]){
  ...
  40:	52                   	push   %edx
  41:	50                   	push   %eax
  42:	e8 4b 03 00 00       	call   392 <waitpid>
        prntinfo();
  47:	e8 4e 03 00 00       	call   39a <prntinfo>
        printf(1, "\nParent prints %d\n", count);
  4c:	83 c4 0c             	add    $0xc,%esp
  4f:	6a 00                	push   $0x0
  51:	68 5e 08 00 00       	push   $0x85e
  56:	6a 01                	push   $0x1
  ...
  76:	e8 77 02 00 00       	call   2f2 <exit>
    ...
    if(pid == 0){ //child
        count = -10;
        chpri(getpid(), 9);
  7b:	e8 f2 02 00 00       	call   372 <getpid>
  80:	51                   	push   %ecx
  81:	51                   	push   %ecx
  82:	6a 09                	push   $0x9
  84:	50                   	push   %eax
  85:	e8 18 03 00 00       	call   3a2 <chpri>
        prntinfo();
  8a:	e8 0b 03 00 00       	call   39a <prntinfo>
        printf(1, "\nChild prints %d\n",count);
  8f:	83 c4 0c             	add    $0xc,%esp
  92:	6a f6                	push   $0xfffffff6
  94:	68 4c 08 00 00       	push   $0x84c
  99:	6a 01                	push   $0x1
  9b:	e8 b0 03 00 00       	call   450 <printf>
  a0:	83 c4 10             	add    $0x10,%esp
  a3:	eb bb                	jmp    60 <main+0x60>
  a5:	66 90                	xchg   %ax,%ax
  a7:	66 90                	xchg   %ax,%ax
  a9:	66 90                	xchg   %ax,%ax
  ab:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ef:	f7 f6                	div    %esi
 3f1:	0f b6 92 78 08 00 00 	movzbl 0x878(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 568:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 56b:	b8 71 08 00 00       	mov    $0x871,%eax
...
malloc(uint nbytes)
{
 ...
 6df:	76 3f                	jbe    720 <malloc+0xa0>
    ...
    if(p == freep)
 6e1:	39 05 10 0b 00 00    	cmp    %eax,0xb10
 ...
 706:	e8 e5 fe ff ff       	call   5f0 <free>
  return freep;
 70b:	8b 15 10 0b 00 00    	mov    0xb10,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 72c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 72f:	89 15 10 0b 00 00    	mov    %edx,0xb10
      return (void*)(p + 1);
 ...
 744:	eb e9                	jmp    72f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 746:	c7 05 10 0b 00 00 14 	movl   $0xb14,0xb10
 74d:	0b 00 00 
 750:	c7 05 14 0b 00 00 14 	movl   $0xb14,0xb14
 757:	0b 00 00 
    base.s.size = 0;
 75a:	b8 14 0b 00 00       	mov    $0xb14,%eax
 75f:	c7 05 18 0b 00 00 00 	movl   $0x0,0xb18
 766:	00 00 00 
