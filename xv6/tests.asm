...
int main(int argc, char *argv[]){
  ...
  26:	e8 15 04 00 00       	call   440 <printf>
    ...
    //chpri(getpid(),25);
    int pid = fork();
  2b:	e8 aa 02 00 00       	call   2da <fork>
    if(pid == 0){ //child
  30:	83 c4 10             	add    $0x10,%esp
  33:	83 f8 00             	cmp    $0x0,%eax
  36:	74 43                	je     7b <main+0x7b>
            x = x * 4.69 + 420;
        }
        prntinfo();
        printf(1, "\nChild prints %d\n",count);
    ...
    if(pid > 0){
  38:	7e 26                	jle    60 <main+0x60>
        waitpid(pid, &status, 0);
  3a:	52                   	push   %edx
  3b:	8d 55 f4             	lea    -0xc(%ebp),%edx
  3e:	6a 00                	push   $0x0
  40:	52                   	push   %edx
  41:	50                   	push   %eax
  42:	e8 3b 03 00 00       	call   382 <waitpid>
        //prntinfo();
        printf(1, "\nParent prints %d\n", count);
  47:	83 c4 0c             	add    $0xc,%esp
  4a:	6a 00                	push   $0x0
  4c:	68 4e 08 00 00       	push   $0x84e
  51:	6a 01                	push   $0x1
  53:	e8 e8 03 00 00       	call   440 <printf>
        prntinfo();
  58:	e8 2d 03 00 00       	call   38a <prntinfo>
  5d:	83 c4 10             	add    $0x10,%esp
    }
    printf(1, "\n Child should be printing before parent since parent waits for child\n");
  60:	83 ec 08             	sub    $0x8,%esp
  63:	68 f4 07 00 00       	push   $0x7f4
  68:	6a 01                	push   $0x1
  ...
  76:	e8 67 02 00 00       	call   2e2 <exit>
        ...
        prntinfo();
  7b:	e8 0a 03 00 00       	call   38a <prntinfo>
        printf(1, "\nChild prints %d\n",count);
  80:	51                   	push   %ecx
  81:	6a f6                	push   $0xfffffff6
  83:	68 3c 08 00 00       	push   $0x83c
  88:	6a 01                	push   $0x1
  8a:	e8 b1 03 00 00       	call   440 <printf>
  8f:	83 c4 10             	add    $0x10,%esp
  92:	eb cc                	jmp    60 <main+0x60>
  94:	66 90                	xchg   %ax,%ax
  96:	66 90                	xchg   %ax,%ax
  98:	66 90                	xchg   %ax,%ax
  9a:	66 90                	xchg   %ax,%ax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3df:	f7 f6                	div    %esi
 3e1:	0f b6 92 68 08 00 00 	movzbl 0x868(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 558:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 55b:	b8 61 08 00 00       	mov    $0x861,%eax
...
free(void *ap)
{
 ...
 5e1:	a1 00 0b 00 00       	mov    0xb00,%eax
static Header base;
static Header *freep;
...
free(void *ap)
{
 ...
 637:	89 08                	mov    %ecx,(%eax)
  freep = p;
 639:	a3 00 0b 00 00       	mov    %eax,0xb00
}
 63e:	5b                   	pop    %ebx
 63f:	5e                   	pop    %esi
 640:	5f                   	pop    %edi
 ...
 65a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 65d:	a3 00 0b 00 00       	mov    %eax,0xb00
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 679:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 67c:	8b 15 00 0b 00 00    	mov    0xb00,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 6cf:	76 3f                	jbe    710 <malloc+0xa0>
    ...
    if(p == freep)
 6d1:	39 05 00 0b 00 00    	cmp    %eax,0xb00
 ...
 6f6:	e8 e5 fe ff ff       	call   5e0 <free>
  return freep;
 6fb:	8b 15 00 0b 00 00    	mov    0xb00,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 71c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 71f:	89 15 00 0b 00 00    	mov    %edx,0xb00
      return (void*)(p + 1);
 ...
 734:	eb e9                	jmp    71f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 736:	c7 05 00 0b 00 00 04 	movl   $0xb04,0xb00
 73d:	0b 00 00 
 740:	c7 05 04 0b 00 00 04 	movl   $0xb04,0xb04
 747:	0b 00 00 
    base.s.size = 0;
 74a:	b8 04 0b 00 00       	mov    $0xb04,%eax
 74f:	c7 05 08 0b 00 00 00 	movl   $0x0,0xb08
 756:	00 00 00 
