...
main(void)
{
  ...
  23:	0f 88 b5 00 00 00    	js     de <main+0xde>
    mknod("console", 1, 1);
    open("console", O_RDWR);
  }
  dup(0);  // stdout
  29:	83 ec 0c             	sub    $0xc,%esp
  2c:	8d 5d f4             	lea    -0xc(%ebp),%ebx
  2f:	6a 00                	push   $0x0
  31:	e8 94 03 00 00       	call   3ca <dup>
  dup(0);  // stderr
  ...
  61:	89 45 f4             	mov    %eax,-0xc(%ebp)
    if(pid < 0){
  64:	78 33                	js     99 <main+0x99>
      printf(1, "init: fork failed\n");
      exit(1);
    }
    if(pid == 0){
  66:	74 4b                	je     b3 <main+0xb3>
  68:	90                   	nop
  ...
  73:	53                   	push   %ebx
  74:	e8 e1 02 00 00       	call   35a <wait>
  79:	83 c4 10             	add    $0x10,%esp
  7c:	85 c0                	test   %eax,%eax
  7e:	78 c8                	js     48 <main+0x48>
  80:	3b 45 f4             	cmp    -0xc(%ebp),%eax
  83:	74 c3                	je     48 <main+0x48>
      printf(1, "zombie!\n");
  85:	83 ec 08             	sub    $0x8,%esp
  88:	68 17 08 00 00       	push   $0x817
  8d:	6a 01                	push   $0x1
  8f:	e8 1c 04 00 00       	call   4b0 <printf>
  94:	83 c4 10             	add    $0x10,%esp
  97:	eb d7                	jmp    70 <main+0x70>
  ...
  99:	53                   	push   %ebx
  9a:	53                   	push   %ebx
  9b:	68 eb 07 00 00       	push   $0x7eb
  a0:	6a 01                	push   $0x1
  a2:	e8 09 04 00 00       	call   4b0 <printf>
      exit(1);
  a7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  ae:	e8 9f 02 00 00       	call   352 <exit>
    }
    if(pid == 0){
      exec("sh", argv);
  b3:	50                   	push   %eax
  b4:	50                   	push   %eax
  b5:	68 c4 0a 00 00       	push   $0xac4
  ba:	68 fe 07 00 00       	push   $0x7fe
  bf:	e8 c6 02 00 00       	call   38a <exec>
      printf(1, "init: exec sh failed\n");
  c4:	5a                   	pop    %edx
  c5:	59                   	pop    %ecx
  c6:	68 01 08 00 00       	push   $0x801
  cb:	6a 01                	push   $0x1
  cd:	e8 de 03 00 00       	call   4b0 <printf>
      exit(1);
  d2:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  d9:	e8 74 02 00 00       	call   352 <exit>
main(void)
{
  int pid, wpid;
  ...
  e8:	e8 ad 02 00 00       	call   39a <mknod>
    open("console", O_RDWR);
  ed:	58                   	pop    %eax
  ee:	5a                   	pop    %edx
  ef:	6a 02                	push   $0x2
  f1:	68 d0 07 00 00       	push   $0x7d0
  f6:	e8 97 02 00 00       	call   392 <open>
  fb:	83 c4 10             	add    $0x10,%esp
  fe:	e9 26 ff ff ff       	jmp    29 <main+0x29>
